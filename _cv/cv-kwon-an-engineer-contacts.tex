...
US Citizen  &  Phone: (617) 475-0054 \\
2432 Jackson Pkwy & Email: \href{mailto:dran@csail.mit.edu}{\color{black}\textit{dran@csail.mit.edu}}
\\
Vienna, VA 22108, USA & Web: \href{http://www.drancom.com}{\color{black}{\textit{www.drancom.com}}}\\%, \href{http://scholar.google.com/citations?user=y1h7segAAAAJ\&hl=en}{\color{black}\textit{Google Scholar Profile}}
\end{tabular}
}

\input{cv-contents-engineer}
\end{myresume}
\end{document}
