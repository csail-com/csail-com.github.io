...
interface UseInfiniteQueryObserverProps {
...
export function useInfiniteQueryObserver({
  data,
  fetchNextPage,
  ref,
  root = null,
  rootMargin = "0px",
  threshold = 0.0,
}: UseInfiniteQueryObserverProps): void {
...
interface useObserverProps {
  target: MutableRefObject<Element | null> | RefObject<Element>;
