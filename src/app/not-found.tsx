    ...
    <>
      ...
      >
        ...
        >
          <div css={{ width: "100%", maxWidth: 500, padding: 20 }}>
            <MotionLayer>
              ...
              >
                ...
                <path
                  d="M337.761 387.33V481.17H356.751V387.33H337.761Z"
                  fill="#A1A1A1"
                />
                <path
                  opacity="0.63"
                ...
                <path
                  opacity="0.5"
                  d="M71.1006 434.25V448.33H337.761V434.25H71.1006Z"
                  fill="#D4B896"
                />
                <path
                  opacity="0.5"
                  d="M71.1104 379.01V489.49H104.51V379.01H71.1104Z"
                  fill="#A0A0A0"
                />
                <path
                ...
                <path
                  d="M2345.95 381.23H1915.63V386.23H2345.95V381.23Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M1787 381.23H1327.11V386.23H1787V381.23Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M1272.05 381.23H957.39V386.23H1272.05V381.23Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M793.13 381.23H522.64V386.23H793.13V381.23Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M2412.53 420.45H1558.33V425.45H2412.53V420.45Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M1458.21 420.45H707.92V425.45H1458.21V420.45Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M680.75 417.95H488.25V422.95H680.75V417.95Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M2529.27 459.66H498.94V464.66H2529.27V459.66Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M2345.94 498.88H2097.05V503.88H2345.94V498.88Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M1796.42 498.88H1261.99V503.88H1796.42V498.88Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M1205.48 498.88H715.69V503.88H1205.48V498.88Z"
                  fill="#CFCFCF"
                />
                <path
                  d="M609.15 498.88H522.64V503.88H609.15V498.88Z"
                  fill="#CFCFCF"
                />
              </svg>
            </MotionLayer>
          ...
          <p css={{ color: "#89898a", fontSize: fontSize.s15 }}>
